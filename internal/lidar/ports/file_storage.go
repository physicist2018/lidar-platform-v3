...
type FileStorage interface {
	...
	// UploadBytes uploads a byte slice as an object. Convenience wrapper over Upload.
	UploadBytes(ctx context.Context, bucket, path string, data []byte, contentType string) error
